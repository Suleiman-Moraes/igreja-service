...
public class EntradaController {
	...
	@PreAuthorize("hasAuthority('ROLE_TESOUREIRO')")
	@PostMapping(value = "/dizimo/{pessoaId}")
	public ResponseEntity<Entrada> inserirDizimo(HttpServletRequest request, @PathVariable("pessoaId") long pessoaId,
			@RequestParam("valor") double valor) throws Exception {
		Entrada objetoNovo = service.inserirDizimo(pessoaId, valor);
