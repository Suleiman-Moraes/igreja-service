...
@Entity
@Table(name = "cargo")
public class Cargo implements Serializable, IDadosAlteracao {
	...
	@JoinTable(name = "cargo_permissao", joinColumns = { @JoinColumn(name = "id_cargo") }, inverseJoinColumns = {
	...
	public Cargo(Long id, String nome, String descricao, AtivoInativoEnum ativo) {
		this.id = id;
		this.nome = nome;
