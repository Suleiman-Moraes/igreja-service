package br.com.suleimanmoraes.igrejanewservice.api.security;
...
import br.com.suleimanmoraes.igrejanewservice.config.security.UsuarioSistema;
...
public class AppUserDetailsService implements UserDetailsService {
	...
	public UserDetails loadUserByUsername(String login) throws UsernameNotFoundException {
		Optional<Usuario> usuarioOptional = service.findByLoginAndAtivoAndIgrejaAtivo(login);
